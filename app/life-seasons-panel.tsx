...
export default function LifeSeasonsPanel({report}:{report:LifeSeasonsReport}) {
  ...
  if(!periods.length) return <section className="life-seasons" id="life-seasons"><h2>나의 인생 4계절</h2><p>그래프를 그릴 대운 구간이 없습니다.</p></section>;
  ...
  return <section className="life-seasons" id="life-seasons" aria-labelledby="life-seasons-title">
    <p className="result-label">개인별 대운으로 본 삶의 리듬</p><h2 id="life-seasons-title">나의 인생 4계절</h2>
