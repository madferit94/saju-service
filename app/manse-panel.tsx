...
export default function MansePanel({chart,benefactors}:{chart:SajuChart;benefactors:Benefactor[]}) {
  ...
  return <>
    <nav className="report-nav" aria-label="결과 바로가기"><a href="#result-title">사주표</a><a href="#manse-elements">오행·십성</a><a href="#deep-analysis-title">균형·도움</a><a href="#life-graph">인생 그래프</a><a href="#life-seasons">인생 4계절</a><a href="#flow-overview">운의 흐름</a><a href="#fortune-domains">생활 운</a></nav>
